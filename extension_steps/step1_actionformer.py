"""
LEGACY EXPORT (large, notebook-derived).

This file is intentionally kept as a raw/linear script version of the original
notebook export. For a clearer, refactored implementation, run:
...
def get_sinusoid_encoding(n_position, d_hid):
    ...
    #conv1 one expects (batch,channels,time) so we unsqueeze to make the shape match
...
# %% [cell 28]
# ------------------------------------------------------------------------------
# Notebook-only plotting/analysis
#
# The original notebook inserted an extra cell here for interactive Colab usage.
# In script form, you can run the comparison section below after you have
# produced `gt_data` / `af_data` / `cl_data` in the earlier export cell.
# ------------------------------------------------------------------------------
